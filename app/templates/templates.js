...
with (locals || {}) {
var interp;
buf.push('<div id="wrap"><div class="container"><nav id="header"><div class="navbar navbar-inverse navbar-fixed-top"><div class="navbar-inner"><div class="container"><a data-toggle="collapse" data-target=".nav-collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a><a href="#" class="brand">Growth App</a><div class="nav-collapse collapse"><ul class="nav"><li class="active"><a href="#">Home</a></li><li><a href="#about">About</a></li><li><a href="#contact">Contact</a></li></ul></div></div></div></div></nav><div id="main"></div><div id="footer"><div class="container"><hr/><p class="muted credit">&copy; Mark Industries</p></div></div></div></div>');
}
return buf.join("");
};
